...
struct Graph {
	...
	void addedge(int u, int v, int w) { e[++cnt] = {v, h[u], w}; h[u] = cnt; } 
}G;
...
struct MST { 
	...
	void init(int n) { for (int i = 1; i <= n * 2; ++i) fa[i] = 0; id = n; }
