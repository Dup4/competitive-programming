...
int main() {
    ...
    Move[2] =
            vector<pII>({mkp(2, 0), mkp(0, 2), mkp(-2, 0), mkp(0, -2), mkp(1, 1), mkp(1, -1), mkp(-1, 1), mkp(-1, -1)});
    Move[3] = vector<pII>({mkp(3, 0), mkp(0, 3), mkp(-3, 0), mkp(0, -3), mkp(1, 2), mkp(1, -2), mkp(-1, 2), mkp(-1, -2),
            mkp(2, 1), mkp(-2, 1), mkp(2, -1), mkp(-2, -1)});
