...
namespace Tarjan {
	int DFN[N], Low[N], fa[N], b[N]; ll sum[N]; 
...
namespace Tree {
	int fa[N], top[N], sze[N], son[N], deep[N]; ll dis[N];
	void dfs(int u) {
		sze[u] = 1; son[u] = 0;
		for (auto &it : G[1][u]) {
			int v = it.fi, w = it.se;
